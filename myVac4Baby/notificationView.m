...
-(void) setUpReminderNotification
{
    ...
    notificationObj.notificationId = @"10";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        /* 1 month || 2 month || 6 months || 9 months */
...
-(void) getFirstNotificationData
{
    ...
    if([arr count] > 0)
    {
        ...
        if([notificationObj.notificationId isEqualToString:@"3"])
        {
            ...
            [nip setNipId:@"10000"];
            [nip setNipTitle:@"6-in-1 Combination Vaccine: DTP, Polio, Hib, Hep B - ask your doctor for more information & the schedule"];
            [nip setNipUrl:@""];
        ...
        else if([notificationObj.notificationId isEqualToString:@"8"])
        {
            ...
            [nip setNipId:@"10000"];
            [nip setNipTitle:@"4-in-1 Combination Vaccine: MMR - VAricella - ask your doctor for more information & the schedule"];
            [nip setNipUrl:@""];
